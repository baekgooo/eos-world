...
.edge-layer{{position:absolute;inset:0;z-index:1;pointer-events:none;overflow:visible}} .edge-layer path{{stroke:#aaa197;stroke-width:1.25;fill:none;transition:stroke .16s ease,stroke-width .16s ease,opacity .16s ease}} .edge-layer path.active-edge{{stroke:#8f5b2e;stroke-width:2.45;opacity:1}}
